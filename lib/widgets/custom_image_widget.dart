    ...
    if (imageUrl != null) {
      switch (imageUrl!.imageType) {
        ...
        case ImageType.file:
          ...
          final path = uri?.scheme == 'file' ? uri!.toFilePath() : imageUrl!;
          return buildFileImage(
            ...
            fallback: () => errorWidget ?? _buildFallbackImage(),
          );
        case ImageType.network:
          return CachedNetworkImage(
            ...
            imageUrl: imageUrl!,
            color: color,
            // Once an image is already in the cache (e.g. it was
            // precached ahead of time while the user was on the
            // previous story), show it immediately instead of
            // crossfading — the fade was making already-loaded
            // images look like they were still lagging behind the text.
        ...
        default:
          return Image.asset(
            ...
            color: color,
            semanticLabel: semanticLabel,
            errorBuilder: (_, __, ___) => errorWidget ?? _buildFallbackImage(),
          );
      }
    }
